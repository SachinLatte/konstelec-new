        	...
        	<div class="row clearfix" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div class="market-block m-block col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	...
                    	<h3><a href="engineering-design.php">Engineering Design</a></h3>
                        <div class="text">Cutting-edge solutions crafted with precision for optimal  performance.</div>
                        <a href="engineering-design.php" class="view_all">Know More <span class="icon flaticon-right-arrow-1"></span></a>
                    </div>
                </div>
                <div class="market-block m-block col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    <div class="icon-box">
                    	...
                    	<h3><a href="procurement.php">Procurement</a></h3>
                        <div class="text">Empowering supply chain success through optimized sourcing strategies.</div>
                        <a href="procurement.php" class="view_all">Know More <span class="icon flaticon-right-arrow-1"></span></a>
                    </div>
                </div>
                <div class="market-block m-block col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<div class="inner-box">
                  <div class="icon-box">
                    	...
                    	<h3><a href="operation-maintenance.php">Operation &amp; Maintenance</a></h3>
                        <div class="text">Responsive to the dynamic nature of modern operations, we adapt to evolving challenges.</div>
                        <a href="operation-maintenance.php" class="view_all">Know More <span class="icon flaticon-right-arrow-1"></span></a>
                    </div>
                </div>
                <div class="market-block m-block col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<div class="inner-box">
                  <div class="icon-box">
                    	...
                    	<h3><a href="construction-commissioning.php">Construction &amp; Comisisonning</a></h3>
                        <div class="text">Crafting quality structures and innovative solutions for seamless construction.</div>
                        <a href="construction-commissioning.php" class="view_all">Know More <span class="icon flaticon-right-arrow-1"></span></a>
                    </div>
                </div>
                <div class="market-block m-block col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<div class="inner-box">
                  <div class="icon-box">
                    	...
                    	<h3><a href="project-management.php">Project Management</a></h3>
                        <div class="text">Managing projects comprehensively, from concept inception to successful completion.</div>
                        <a href="project-management.php" class="view_all">Know More <span class="icon flaticon-right-arrow-1"></span></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="tab1" class="tab-contents active">
              <div class="row g-0">
                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                    ...
                    <a href="hydrocarbon.php" class="more_category">Know More</a>
                    </div>
                </div>
              </div>
            </div>
            <div id="tab2" class="tab-contents">
              <div class="row">
                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                    ...
                    <a href="power.php" class="more_category">Know More</a>
                    </div>
                </div>
              </div>
            </div>
            <div id="tab3" class="tab-contents">
              <div class="row">
                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                    ...
                    <a href="steel-cement.php" class="more_category">Know More</a>
                    </div>
                </div>
              </div>
            </div>
            <div id="tab4" class="tab-contents">
              <div class="row">
                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                    ...
                    <a href="substation.php" class="more_category">Know More</a>
                    </div>
                </div>
              </div>
            </div>
            <div id="tab5" class="tab-contents">
              <div class="row">
                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                    ...
                    <a href="port-pharmaceutical.php" class="more_category">Know More</a>
                    </div>
                </div>
              </div>
            </div>
            <div id="tab6" class="tab-contents">
              <div class="row">
                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                    ...
                    <a href="international-projects.php" class="more_category">Know More</a>
                    </div>
                </div>
              </div>
            </div>
    ...
    <section class="our-clients common-padding">
      <div class="auto-container">
          ...
          <div class="owl-slider" data-aos="fade-down" data-aos-duration="1000">
            ...
            <a href="clients.php" class="more_category">Know More</a>
          </div>
      </div>
    </section>
